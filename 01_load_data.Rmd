...
```{r fixDataFun}
# TODO!
fix_screening_log <- function(screen_log){
  screen_log[errors_logi, "Excl_criteria_ok"] = "N"
  screen_log[errors_logi, "Incl_criteria_ok"] = NA
  screen_log[errors_logi, "Already_AKI"] = "Y"
  screen_log[errors_logi, "Epis_olig"] = NA
  screen_log[errors_logi, "Total_no_olig_epis"] = NA
  return(screen_log)
}
