...
The first added term $\Delta\text{Cr}$ is the change in creatinine during the defined length of
...
The first added term $\Delta\text{Cr}$ is the creatinine change during an event.
