...
# ---- cr_ch_multi_heuristic_plot ----
ggplot(cr_ch_plot, aes(centre, width)) +
  geom_contour_fill(aes(z = heuristic), bins = 32, alpha = 1, na.fill = TRUE) +
...
# ---- cr_ch_multi_optim_summary ----
kable(head(optim_cr_ch_multi, 30))
